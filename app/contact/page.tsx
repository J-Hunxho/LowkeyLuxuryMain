  ...
  return (
    <div className="shell py-24">
      <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr]">
        <Reveal>
          <p className="eyebrow mb-4">Apply to work</p>
          <h1 className="font-serif text-5xl sm:text-6xl">For businesses ready for real infrastructure.</h1>
          <p className="mt-6 max-w-xl text-lg leading-8 text-white/58">
            Share the current bottleneck, the target state, and the operating environment. If the fit is right, the next move will be precise.
          </p>
        ...
        <Reveal delay={0.12} className="panel p-8 lg:p-10">
